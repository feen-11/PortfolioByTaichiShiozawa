          ...
          <h2 class="heading">ユーザー情報の変更</h2>
            ...
            <form action="" method="post" id="editUser">
              <div class="user-name-edit row justify-content-between">
                ...
                <input class="col-sm-12 col-md-8" type="text" name="name" placeholder="name" value="<?php echo h($_SESSION['me']['name']) ?>">
              ...
              <div class="user-email-edit row justify-content-between">
                ...
                <input class="col-sm-12 col-md-8" type="text" name="email" placeholder="email" value="<?php echo h($_SESSION['me']['email']) ?>">
                <p class="err"><?= h($app->getErrors('email'));?></p>
              </div>
              <div class="user-email-edit row justify-content-between">
                <p class="col-sm-12 col-md-4"><i class="fas fa-arrow-up fa-lg"></i> 身長</p>
                <input class="col-sm-12 col-md-8" type="text" name="height" placeholder="email" value="<?php echo h($_SESSION['me']['height']) ?>">
                <p class="err"><?= h($app->getErrors('height'));?></p>
              </div>
              <div class="user-email-edit row justify-content-between">
                <p class="col-sm-12 col-md-4"><i class="fab fa-pagelines fa-lg"></i> 年齢</p>
                <input class="col-sm-12 col-md-8" type="text" name="age" placeholder="年齢（数値のみ）" value="<?php echo h($_SESSION['me']['age']) ?>">
                <p class="err"><?= h($app->getErrors('age'));?></p>
              </div>
              <div class="user-email-edit row justify-content-between">
                <p class="col-sm-12 col-md-4">スタート体重</p>
                <input class="col-sm-12 col-md-8" type="text" name="weight" placeholder="スタート時体重kg" value="<?php echo h($_SESSION['me']['weight']) ?>">
                <p class="err"><?= h($app->getErrors('weight'));?></p>
              </div>
              <div class="user-email-edit row justify-content-between">
                <p class="col-sm-12 col-md-4">現在の体重</p>
                <input class="col-sm-12 col-md-8" type="text" name="nowWeight" placeholder="現在の体重kg" value="<?php echo h($_SESSION['me']['nowWeight']) ?>">
                <p class="err"><?= h($app->getErrors('nowWeight'));?></p>
              </div>
              <div class="user-email-edit row justify-content-between">
                <p class="col-sm-12 col-md-4">目標体重</p>
                <input class="col-sm-12 col-md-8" type="text" name="goalWeight" placeholder="目標体重kg" value="<?php echo h($_SESSION['me']['goalWeight']) ?>">
                <p class="err"><?= h($app->getErrors('goalWeight'));?></p>
              </div>
              <div class="user-email-edit row justify-content-between">
                <p class="col-sm-12 col-md-4"><i class="fas fa-flag-checkered fa-lg"></i> 意気込み</p>
                <textarea class="col-sm-12 col-md-8" name="declaration" id=""><?php echo  isset($app->getValues()->declaration) ? h($app->getValues()->declaration) : $_SESSION['me']['declaration'] ?></textarea>
